# OptiTrade Engine Level 3 Final Results

## Overview

OptiTrade Engine is a C++20 low-latency electronic trading packet processor using a
...
Linux raw generator on ot_peer
  -> private veth pair
  -> ot_eng
  -> DPDK AF_PACKET RX
  -> TradingEngine
...
OptiTrade Engine achieved 110.8 ns p50 / 552.2 ns p99 on a virtual DPDK Ring PMD
