# OptiTrade Engine Upcoming Version V2
...
Run OptiTrade Engine on a machine with a supported wired DPDK NIC.
...
```text
OptiTrade Engine V2 extends the C++20/DPDK trading engine from controlled synthetic
