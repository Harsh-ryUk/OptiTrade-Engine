...
inline constexpr const char* kLatencyMempoolName = "ot_lmp";
inline constexpr const char* kLatencyMarketRingName = "ot_lmd";
inline constexpr const char* kLatencyOrderRingName = "ot_lor";
inline constexpr const char* kLatencyGeneratorPortName = "ot_lgen";
inline constexpr const char* kLatencyEnginePortName = "ot_leng";
